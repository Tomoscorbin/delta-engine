...
def read_primary_key(
    ...
    if not ordered:
        return None
    return ObservedPrimaryKey(
        columns=[row.column_name for row in ordered],
        catalog_name=ordered[0].constraint_name,
    )
