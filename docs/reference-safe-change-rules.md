...
| `UnsupportedChangeRejected` | Changing a column's declared data type, or changing `partitioned_by` on an existing table | Drop and recreate the table out of band, then re-sync |
