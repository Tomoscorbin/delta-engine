...
| Primary keys              |       ✓       | Declared at table level; creation names may be requested ([primary keys](how-to-configure-table.md#primary-keys))                                                                                                         |
| Foreign keys              |       ✓       | Must target the referenced table's primary key; orders the sync; creation names may be requested ([foreign keys](how-to-configure-table.md#foreign-keys))                                                                  |
