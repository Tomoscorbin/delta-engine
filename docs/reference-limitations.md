...
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Backend               | Delta Lake tables on Databricks with Unity Catalog — the supported target today; the reader reads managed and external Delta tables only, and any other relation a registered name resolves to (view, materialized view, streaming table, foreign table, non-Delta format) fails its read ([architecture](explanation-architecture.md))   |
