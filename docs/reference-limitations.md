...
| Loosen nullability        |       ✓       | `NOT NULL` → nullable is applied to top-level columns and fields reachable directly through structs                                                                                                                       |
| Tighten nullability       |       ✗       | Top-level and directly nested struct fields are blocked — backfill first, then tighten ([rules](reference-safe-change-rules.md))                                                                                          |
