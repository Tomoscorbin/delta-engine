...
- [ ] utilise **init** **all** so that we can reduce the number of import line
...
- [ ] review if we need from **future** import annotations
...
- [x] put domain constraints into single file
