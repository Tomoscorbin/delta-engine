...
def test_public_api_exposes_the_intended_names():
    ...
    from delta_engine.application import Engine, Failure, SyncFailedError, SyncReport
    ...
    assert set(application.__all__) == {"Engine", "SyncFailedError", "SyncReport", "Failure"}
