...
def test_resolve_reports_invalid_fk_target_over_cycle_for_the_same_fk():
    ...
    b = DesiredTable(
        ...
        primary_key=PrimaryKeyConstraint(columns=("id",), name="b_pk"),
        foreign_keys=(
    ...
    a = DesiredTable(
        ...
        primary_key=PrimaryKeyConstraint(columns=("id",), name="a_pk"),
        foreign_keys=(
            ForeignKeyConstraint(
    ...
    orders = DesiredTable(
        ...
        foreign_keys=(
            ForeignKeyConstraint(
                ...
                name="orders_country_code_customer_id_fk",
            ),
        ),
    )
