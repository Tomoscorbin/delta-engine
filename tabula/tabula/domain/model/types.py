...
def integer() -> DataType:   return _INT
def smallint() -> DataType:  return _SMALLINT
def boolean() -> DataType:   return _BOOLEAN
def string() -> DataType:    return _STRING
def date() -> DataType:      return _DATE
def timestamp() -> DataType: return _TIMESTAMP
def double() -> DataType:    return _DOUBLE
def float32() -> DataType:   return _FLOAT
def float64() -> DataType:   return _DOUBLE
